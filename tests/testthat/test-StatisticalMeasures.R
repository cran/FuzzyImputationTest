test_that("Function returns correct values", {
  ...
  testDF1Res <- as.data.frame(testMatrix1Res)
  ...
  testDF2Res <- as.data.frame(testMatrix2Res)
  ...
  testDF1Mask <- as.data.frame(testMatrix1Mask)
  ...
  testDF2Mask <- as.data.frame(testMatrix2Mask)
  ...
  expect_snapshot(
    
    {
      ...
      StatisticalMeasures(trueData=testMatrix1,imputedData=testMatrix1Res,imputedMask=testMatrix1Mask)
  ...
  expect_snapshot(
    
    {
      ...
      StatisticalMeasures(trueData=testMatrix2,imputedData=testMatrix2Res,imputedMask=testMatrix2Mask)
...
test_that("Function reports errors", {
  ...
  expect_error(StatisticalMeasures(trueData=0.53,imputedData=testMatrix1,imputedMask=testMatrix1Mask),
               
               "Parameter trueData should be a data frame or a matrix!")
  
  
  expect_error(StatisticalMeasures(trueData=testMatrixBad,imputedData=testMatrix1,imputedMask=testMatrix1Mask),
               
               "Parameter trueData should have numerical values!")
  
  
  expect_error(StatisticalMeasures(trueData=testMatrix1,imputedData=testMatrix1,imputedMask=testMatrixBad),
               
               "Parameter imputedMask should have logical values!")
  
  expect_error(StatisticalMeasures(trueData=testMatrix1,imputedData=testMatrix2,imputedMask=testMatrix1Mask),
               
               "The parameters trueData, imputedData, imputedMask should have the same number of columns!")
  
  expect_error(StatisticalMeasures(trueData=testMatrix1,imputedData=testMatrixBadC,imputedMask=testMatrix1Mask),
