test_that("Function returns correct values", {
  ...
  expect_snapshot(
    
    {
      ...
      ApplyStatisticalTests(trueData=testMatrix1,imputedData=testMatrix1Res,imputedMask=testMatrix1Mask,cutsNumber = 100, K=10,trapezoidal = TRUE)
  ...
  expect_snapshot(
    
    {
      ...
      ApplyStatisticalTests(trueData=testMatrix2,imputedData=testMatrix2Res,imputedMask=testMatrix2Mask,cutsNumber = 100, K=10,trapezoidal = FALSE)
...
test_that("Function reports errors", {
  ...
  expect_error(ApplyStatisticalTests(trueData=0.53,imputedData=testMatrix1,imputedMask=testMatrix1Mask,trapezoidal=TRUE),
               
               "Parameter trueData should be a data frame or a matrix!")
  
  
  expect_error(ApplyStatisticalTests(trueData=testMatrixBad,imputedData=testMatrix1,imputedMask=testMatrix1Mask,trapezoidal=TRUE),
               
               "Parameter trueData should be a numerical matrix or dataframe!")
  
  expect_error(ApplyStatisticalTests(trueData=testMatrix1,imputedData=testMatrix1,imputedMask=testMatrix1Mask,trapezoidal=c(12,3)),
               
               "Parameter trapezoidal should be a single logical value!")
  
  expect_error(ApplyStatisticalTests(trueData=testMatrix1,imputedData=testMatrix1,imputedMask=testMatrixBad,trapezoidal=TRUE),
               
               "Parameter imputedMask should be a logical matrix or dataframe!")
  
  expect_error(ApplyStatisticalTests(trueData=testMatrix1,imputedData=testMatrix2,imputedMask=testMatrix1Mask,trapezoidal=TRUE),
